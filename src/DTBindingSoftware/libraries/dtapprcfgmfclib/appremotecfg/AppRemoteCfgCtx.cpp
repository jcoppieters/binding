...
void AppRemoteCfgClientCredentials::clear() {
...
/**************************************************************/
/**************************************************************/
AppRemoteCfgCtx::AppRemoteCfgCtx() : m_credentials(), m_serverInfo(), m_directory(), m_fileName(),
	m_hostName(), m_port(0), m_connected(false), 
	m_pCurrentTask(0), m_state(STATE_IDLE) { }
