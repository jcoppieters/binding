...
/************************************************
 * AVSettings create configuratie.
 ************************************************/
class CConfigAlgViewAVSettings : public CConfigAlgView
{
public:
	CConfigAlgViewAVSettings(CCanNode* pNode,IViewDisplay* pNotifyView);
	virtual ~CConfigAlgViewAVSettings(void);
