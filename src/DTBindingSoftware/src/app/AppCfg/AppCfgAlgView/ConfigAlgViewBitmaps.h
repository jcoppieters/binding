...
/************************************************
 * Bitmaps configuratie.
 ************************************************/
class CConfigAlgViewBitmaps : public CConfigAlgView
{
public:
	CConfigAlgViewBitmaps(CCanNode* pNode,IViewDisplay* pNotifyView);
	virtual ~CConfigAlgViewBitmaps(void);
