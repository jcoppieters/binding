...
/************************************************
 * IRRX create configuratie.
 ************************************************/
class CConfigAlgViewIRRX : public CConfigAlgView
{
public:
	CConfigAlgViewIRRX(CCanNode* pNode,IViewDisplay* pNotifyView);
	virtual ~CConfigAlgViewIRRX(void);
