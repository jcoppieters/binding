...
/************************************************
 * IRTX create configuratie.
 ************************************************/
class CConfigAlgViewIRTX : public CConfigAlgView
{
public:
	CConfigAlgViewIRTX(CCanNode* pNode,IViewDisplay* pNotifyView);
	virtual ~CConfigAlgViewIRTX(void);
