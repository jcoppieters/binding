...
/************************************************
 * Smap AV Room configuratie.
 ************************************************/
class CConfigAlgViewSmapAVRoom : public CConfigAlgView
{
public:
	CConfigAlgViewSmapAVRoom(CCanNode* pNode,IViewDisplay* pNotifyView);
	virtual ~CConfigAlgViewSmapAVRoom(void);
