 ...
 * Duotecno Mobile App
 ************************************************/
class CConfigAlgViewMobileApp : public CConfigAlgView
{
public:
	CConfigAlgViewMobileApp(CCanNode* pNode,IViewDisplay* pNotifyView);
	virtual ~CConfigAlgViewMobileApp(void);
