...
/************************************************
 * Roomcontroller AV Configuratie.
 ************************************************/
class CConfigAlgViewRoomCtrlAV : public CConfigAlgView
{
public:
	CConfigAlgViewRoomCtrlAV(CCanNode* pNode,IViewDisplay* pNotifyView);
	virtual ~CConfigAlgViewRoomCtrlAV(void);
