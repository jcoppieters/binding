...
/************************************************
 * Moods create configuratie.
 ************************************************/
class CConfigAlgViewMoods : public CConfigAlgView
{
public:
	CConfigAlgViewMoods(CCanNode* pNode,IViewDisplay* pNotifyView);
	virtual ~CConfigAlgViewMoods(void);
