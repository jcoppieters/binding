...
//////////////////////////////////////////////////////////////////////
CConfigMoodCreateFile::CConfigMoodCreateFile() :
...
{	
	...
	m_ppConfigBaseClass[ConfigMoodClasses::ENUM_CONFIGCLASS_MOOD] = 
		new CConfigMoodClass(&m_configErrors);		
...
CConfigMoodCreateFile::GetClass(int type)	
{
	if (type < MAX_CLASSES) 
	{
...
CString CConfigMoodCreateFile::GetErrors(int i)
{
...
///////////////////////////////////////////////////////////////////////
BOOL CConfigMoodCreateFile::Initialise(void)
{
	if (m_pConfigFile != 0)
...
BOOL CConfigMoodCreateFile::Load(CString szFilename)
{
	if (m_pConfigFile != 0)
	{
		Initialise( );
