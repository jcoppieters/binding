// BindingFileEntryFormatterN.cpp: implementation of the CBindingFileEntryFormatterN class.
//
//////////////////////////////////////////////////////////////////////
...
CBindingFileEntryFormatterN::CBindingFileEntryFormatterN(CBindingEntryInfo* pBindingEntryInfo,
...
CBindingFileEntryFormatterN::~CBindingFileEntryFormatterN()
{

}

BOOL CBindingFileEntryFormatterN::Format()
{
		...
		m_pReturnUnit != NULL)
	{
		...
		m_szBindingFileEntry.FreeExtra();
