...
class CBindingDuoSwitchUnit : public CBindingUnit
{
protected:
	virtual void Init(void);		//TM 20040701

public:
	CBindingDuoSwitchUnit(BYTE bBindingUnitType);
	CBindingDuoSwitchUnit(const CBindingUnit& pBindingUnit);// Oppassen: Dit is geen COPY Constructor !!!!!
	/********************************************************************************** 
	 * Oppassen: Copy constructor wordt impliciet aangeroepen.
	 **********************************************************************************/
	virtual ~CBindingDuoSwitchUnit(); 
...
protected:
	...
	BYTE bSwitchSwitchTimerReloadValue;
...
public:
	...
	void Set_SwitchTime(BYTE bTime) {bSwitchSwitchTimerReloadValue = bTime; };
	...
	BYTE Get_SwitchTime(void) const {
		return bSwitchSwitchTimerReloadValue; 
	};
...
class CBindingDuoSwitchUnitInput : public CBindingDuoSwitchUnit
{
protected:
	virtual void Init(void);		//TM 20040701

private:
	CBindingDuoSwitchUnitInput& operator=(const CBindingDuoSwitchUnitInput& BindingUnit);

public:
	CBindingDuoSwitchUnitInput(BYTE bBindingUnitType); 
	CBindingDuoSwitchUnitInput(const CBindingUnit& pBindingUnit);	// Oppassen: Dit is geen COPY Constructor !!!!!
	/********************************************************************************** 
	 * Oppassen: Copy constructor wordt impliciet aangeroepen.
	 **********************************************************************************/
	virtual ~CBindingDuoSwitchUnitInput(); 
...
private:
	typedef CBindingDuoSwitchUnit Base;
};