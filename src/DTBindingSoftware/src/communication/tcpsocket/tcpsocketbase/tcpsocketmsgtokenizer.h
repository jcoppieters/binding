...
#include <vector>
#include <algorithm>
//#include <locale>			// TM 20070711
#include <cctype>			// TM 20070711
...
{
  // TM_CHANGES_MSVC2008: isspace geeft een int terug ipv een bool.

  //isspace<char> returns true if c is a white-space character (0x09-0x0D or 0x20)

  return (isspace(c) != 0 ? true : false );			// TM 20070711
}
