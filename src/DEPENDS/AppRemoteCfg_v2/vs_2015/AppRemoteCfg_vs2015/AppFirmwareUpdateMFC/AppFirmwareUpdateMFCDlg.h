...
// AppFirmwareUpdateMFCDlg.h : header file
//
...
class CAppFirmwareUpdateMFCDlg_Host;

/****************************************************************************/
/****************************************************************************/
/****************************************************************************/
// CAppFirmwareUpdateMFCDlg dialog
class CAppFirmwareUpdateMFCDlg : public CDialogEx
{
// Construction
public:
	CAppFirmwareUpdateMFCDlg(CWnd* pParent = NULL);	// standard constructor
	~CAppFirmwareUpdateMFCDlg();

	void init(AppFirmwareUpdaterWorker& refWorker,const CString& strIpAddress);

// Dialog Data
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_APPFIRMWAREUPDATEMFC_DIALOG };
#endif
...
private:
	...
	friend class CAppFirmwareUpdateMFCDlg_Host;	
};
/****************************************************************************/
...
/****************************************************************************/
/****************************************************************************/
class CAppFirmwareUpdateMFCDlg_Host : public IAppFirmwareUpdaterWorkerWindowHost
{
public:
	CAppFirmwareUpdateMFCDlg_Host(CAppFirmwareUpdateMFCDlg& refDlg);
	virtual ~CAppFirmwareUpdateMFCDlg_Host();
...
private:
	CAppFirmwareUpdateMFCDlg& m_refParentDlg;
};
/****************************************************************************/
