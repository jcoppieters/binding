========================================================================
    STATIC LIBRARY : dtapprcfgmfclib Project Overview
========================================================================

AppWizard has created this dtapprcfgmfclib library project for you.

This file contains a summary of what you will find in each of the files that
make up your dtapprcfgmfclib application.


dtapprcfgmfclib.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    named dtapprcfgmfclib.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "dtapprcfgmfclib.rc" and a "dtapprcfgmfclib.h" that
