...
/**************************************************************/
// Sedert V1.8: utility functies voor de nodeSevices cfg..
extern bool appremoteCfg_getNodeServicePassword(AppRemoteCfgNodes& src,int nodeAddress,CString* pwd);

extern bool appremoteCfg_getNodeServiceSettings(AppRemoteCfgNodes& src,int nodeAddress,AppRemoteCfgService_t service,
												AppRemoteCfgHostAddress_t addressType, CString* hostAddress,int* port);

extern bool appremoteCfg_getNodeServiceSettingsValid(AppRemoteCfgNodes& src,int nodeAddress,AppRemoteCfgService_t type,
													 AppRemoteCfgHostAddress_t addressType);		


// Updaten van de services...
extern bool appremoteCfg_updateNodeService(AppRemoteCfgNodes* dest,int nodeAddress,AppRemoteCfgService_t type, 
...
// Sedert V1.8: Utility functie.
// De node services tcp/ip protocol updaten met deze van de inlog gegevens.
// Dit is handig wanneer we connecteren met een tcp/ip als master. Dan worden de nodige node 
// nodeservices van tcp/ip upgedate/ingevuld voor de master taken...
extern bool appremoteCfg_updateNodeService(AppRemoteCfgNodes* dest,const AppRemoteCfgLoginInfo& src);
